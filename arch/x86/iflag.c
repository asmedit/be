...
const iflag_t insns_flags[273] = {
    ...
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00400000),UINT32_C(0x00020020)}}, /*  17 : CYRIX,OBSOLETE,PENT */
    ...
    {{UINT32_C(0x00000001),UINT32_C(0x00000208),UINT32_C(0x00400000),UINT32_C(0x00000010)}}, /*  33 : 486,LOCK,OBSOLETE,SM,UNDOC */
    {{UINT32_C(0x00000000),UINT32_C(0x00000200),UINT32_C(0x00400000),UINT32_C(0x00000010)}}, /*  34 : 486,OBSOLETE,UNDOC */
    ...
    {{UINT32_C(0x00000008),UINT32_C(0x00000200),UINT32_C(0x00400000),UINT32_C(0x00000008)}}, /*  49 : 386,OBSOLETE,SW,UNDOC */
    {{UINT32_C(0x00000000),UINT32_C(0x00000200),UINT32_C(0x00400000),UINT32_C(0x00000008)}}, /*  50 : 386,OBSOLETE,UNDOC */
    {{UINT32_C(0x00000010),UINT32_C(0x00000200),UINT32_C(0x00400000),UINT32_C(0x00000008)}}, /*  51 : 386,OBSOLETE,SD,UNDOC */
    ...
    {{UINT32_C(0x00000000),UINT32_C(0x00000200),UINT32_C(0x00400000),UINT32_C(0x00000004)}}, /*  71 : 286,OBSOLETE,UNDOC */
    ...
    {{UINT32_C(0x00000000),UINT32_C(0x00000200),UINT32_C(0x00400000),UINT32_C(0x00000001)}}, /*  93 : 8086,OBSOLETE,UNDOC */
    ...
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00400000),UINT32_C(0x00020010)}}, /* 112 : 486,CYRIX,OBSOLETE */
    ...
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00400000),UINT32_C(0x00000002)}}, /* 116 : 186,OBSOLETE */
    ...
    {{UINT32_C(0x00000000),UINT32_C(0x00800000),UINT32_C(0x02000000),UINT32_C(0x00002000)}}, /* 188 : AVX,SANDYBRIDGE,VEX */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x02001000),UINT32_C(0x00004000)}}, /* 189 : FUTURE,VAES,VEX */
    {{UINT32_C(0x00000000),UINT32_C(0x80000000),UINT32_C(0x04001040),UINT32_C(0x00004000)}}, /* 190 : AVX512,AVX512VL,EVEX,FUTURE,VAES */
    {{UINT32_C(0x00000000),UINT32_C(0x80000000),UINT32_C(0x04001000),UINT32_C(0x00004000)}}, /* 191 : AVX512,EVEX,FUTURE,VAES */
    {{UINT32_C(0x00000040),UINT32_C(0x00800000),UINT32_C(0x02000000),UINT32_C(0x00002000)}}, /* 192 : AVX,SANDYBRIDGE,SO,VEX */
    {{UINT32_C(0x00000080),UINT32_C(0x00800000),UINT32_C(0x02000000),UINT32_C(0x00002000)}}, /* 193 : AVX,SANDYBRIDGE,SY,VEX */
    {{UINT32_C(0x00000000),UINT32_C(0x00800020),UINT32_C(0x02000000),UINT32_C(0x00002000)}}, /* 194 : AVX,LONG,SANDYBRIDGE,VEX */
    {{UINT32_C(0x00000010),UINT32_C(0x00800000),UINT32_C(0x02000000),UINT32_C(0x00002000)}}, /* 195 : AVX,SANDYBRIDGE,SD,VEX */
    {{UINT32_C(0x00000020),UINT32_C(0x00800020),UINT32_C(0x02000000),UINT32_C(0x00002000)}}, /* 196 : AVX,LONG,SANDYBRIDGE,SQ,VEX */
    {{UINT32_C(0x00000020),UINT32_C(0x00800000),UINT32_C(0x02000000),UINT32_C(0x00002000)}}, /* 197 : AVX,SANDYBRIDGE,SQ,VEX */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x02002000),UINT32_C(0x00004000)}}, /* 198 : FUTURE,VEX,VPCLMULQDQ */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04002040),UINT32_C(0x00004000)}}, /* 199 : AVX512VL,EVEX,FUTURE,VPCLMULQDQ */
    {{UINT32_C(0x00000000),UINT32_C(0x80000000),UINT32_C(0x04002000),UINT32_C(0x00004000)}}, /* 200 : AVX512,EVEX,FUTURE,VPCLMULQDQ */
    {{UINT32_C(0x00000000),UINT32_C(0x02000000),UINT32_C(0x02000000),UINT32_C(0x00004000)}}, /* 201 : FMA,FUTURE,VEX */
    {{UINT32_C(0x00000000),UINT32_C(0x00800000),UINT32_C(0x02000000),UINT32_C(0x00004000)}}, /* 202 : AVX,FUTURE,VEX */
    {{UINT32_C(0x00000000),UINT32_C(0x00000001),UINT32_C(0x00000000),UINT32_C(0x00004000)}}, /* 203 : FUTURE,PRIV */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x02000000),UINT32_C(0x00040008)}}, /* 204 : 386,AMD,VEX */
    {{UINT32_C(0x00000000),UINT32_C(0x00000020),UINT32_C(0x02000000),UINT32_C(0x00040400)}}, /* 205 : AMD,LONG,VEX,X86_64 */
    {{UINT32_C(0x00000000),UINT32_C(0x00400000),UINT32_C(0x02000000),UINT32_C(0x00040000)}}, /* 206 : AMD,SSE5,VEX */
    {{UINT32_C(0x00000000),UINT32_C(0x01000000),UINT32_C(0x02000000),UINT32_C(0x00004000)}}, /* 207 : AVX2,FUTURE,VEX */
    ...
    {{UINT32_C(0x00000000),UINT32_C(0x04000000),UINT32_C(0x02000000),UINT32_C(0x00004000)}}, /* 212 : BMI1,FUTURE,VEX */
    {{UINT32_C(0x00000000),UINT32_C(0x04000020),UINT32_C(0x02000000),UINT32_C(0x00004000)}}, /* 213 : BMI1,FUTURE,LONG,VEX */
    {{UINT32_C(0x00000000),UINT32_C(0x10000000),UINT32_C(0x02000000),UINT32_C(0x00004000)}}, /* 214 : FUTURE,TBM,VEX */
    {{UINT32_C(0x00000000),UINT32_C(0x10000020),UINT32_C(0x02000000),UINT32_C(0x00004000)}}, /* 215 : FUTURE,LONG,TBM,VEX */
    {{UINT32_C(0x00000000),UINT32_C(0x08000000),UINT32_C(0x02000000),UINT32_C(0x00004000)}}, /* 216 : BMI2,FUTURE,VEX */
    {{UINT32_C(0x00000000),UINT32_C(0x08000020),UINT32_C(0x02000000),UINT32_C(0x00004000)}}, /* 217 : BMI2,FUTURE,LONG,VEX */
    ...
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x02000000),UINT32_C(0x00004000)}}, /* 228 : FUTURE,VEX */
    {{UINT32_C(0x00000001),UINT32_C(0x00000000),UINT32_C(0x02000000),UINT32_C(0x00004000)}}, /* 229 : FUTURE,SM,VEX */
    {{UINT32_C(0x00000005),UINT32_C(0x00000000),UINT32_C(0x02000000),UINT32_C(0x00004000)}}, /* 230 : FUTURE,SB,SM,VEX */
    {{UINT32_C(0x00000400),UINT32_C(0x00000000),UINT32_C(0x02000000),UINT32_C(0x00004000)}}, /* 231 : FUTURE,SX,VEX */
    {{UINT32_C(0x00000002),UINT32_C(0x00000000),UINT32_C(0x02000000),UINT32_C(0x00004000)}}, /* 232 : FUTURE,SM2,VEX */
    {{UINT32_C(0x00000000),UINT32_C(0x80000000),UINT32_C(0x04000040),UINT32_C(0x00004000)}}, /* 233 : AVX512,AVX512VL,EVEX,FUTURE */
    {{UINT32_C(0x00000000),UINT32_C(0x80000000),UINT32_C(0x04000000),UINT32_C(0x00004000)}}, /* 234 : AVX512,EVEX,FUTURE */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x040000c0),UINT32_C(0x00004000)}}, /* 235 : AVX512DQ,AVX512VL,EVEX,FUTURE */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04000080),UINT32_C(0x00004000)}}, /* 236 : AVX512DQ,EVEX,FUTURE */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04000140),UINT32_C(0x00004000)}}, /* 237 : AVX512BW,AVX512VL,EVEX,FUTURE */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04000100),UINT32_C(0x00004000)}}, /* 238 : AVX512BW,EVEX,FUTURE */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04000002),UINT32_C(0x00004000)}}, /* 239 : AVX512ER,EVEX,FUTURE */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04000004),UINT32_C(0x00004000)}}, /* 240 : AVX512PF,EVEX,FUTURE */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04000041),UINT32_C(0x00004000)}}, /* 241 : AVX512CD,AVX512VL,EVEX,FUTURE */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04000001),UINT32_C(0x00004000)}}, /* 242 : AVX512CD,EVEX,FUTURE */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04000440),UINT32_C(0x00004000)}}, /* 243 : AVX512VBMI,AVX512VL,EVEX,FUTURE */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04000400),UINT32_C(0x00004000)}}, /* 244 : AVX512VBMI,EVEX,FUTURE */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04000240),UINT32_C(0x00004000)}}, /* 245 : AVX512IFMA,AVX512VL,EVEX,FUTURE */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04000200),UINT32_C(0x00004000)}}, /* 246 : AVX512IFMA,EVEX,FUTURE */
    ...
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x01c00000),UINT32_C(0x00004000)}}, /* 250 : FUTURE,NEVER,NOP,OBSOLETE */
    ...
    {{UINT32_C(0x00000000),UINT32_C(0x00800000),UINT32_C(0x02004000),UINT32_C(0x00004000)}}, /* 257 : AVX,FUTURE,GFNI,VEX */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04004040),UINT32_C(0x00004000)}}, /* 258 : AVX512VL,EVEX,FUTURE,GFNI */
    {{UINT32_C(0x00000000),UINT32_C(0x80000000),UINT32_C(0x04004000),UINT32_C(0x00004000)}}, /* 259 : AVX512,EVEX,FUTURE,GFNI */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04008040),UINT32_C(0x00004000)}}, /* 260 : AVX512VBMI2,AVX512VL,EVEX,FUTURE */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04008000),UINT32_C(0x00004000)}}, /* 261 : AVX512VBMI2,EVEX,FUTURE */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04010040),UINT32_C(0x00004000)}}, /* 262 : AVX512VL,AVX512VNNI,EVEX,FUTURE */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04010000),UINT32_C(0x00004000)}}, /* 263 : AVX512VNNI,EVEX,FUTURE */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04020040),UINT32_C(0x00004000)}}, /* 264 : AVX512BITALG,AVX512VL,EVEX,FUTURE */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04020000),UINT32_C(0x00004000)}}, /* 265 : AVX512BITALG,EVEX,FUTURE */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04040040),UINT32_C(0x00004000)}}, /* 266 : AVX512VL,AVX512VPOPCNTDQ,EVEX,FUTURE */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x04040000),UINT32_C(0x00004000)}}, /* 267 : AVX512VPOPCNTDQ,EVEX,FUTURE */
    {{UINT32_C(0x00000040),UINT32_C(0x00000000),UINT32_C(0x04080000),UINT32_C(0x00004000)}}, /* 268 : AVX5124FMAPS,EVEX,FUTURE,SO */
    {{UINT32_C(0x00000040),UINT32_C(0x00000000),UINT32_C(0x04100000),UINT32_C(0x00004000)}}, /* 269 : AVX5124VNNIW,EVEX,FUTURE,SO */
    {{UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00200000),UINT32_C(0x00004000)}}, /* 270 : FUTURE,SGX */
    {{UINT32_C(0x00000000),UINT32_C(0x00000200),UINT32_C(0x00000000),UINT32_C(0x00000040)}}, /* 271 : P6,UNDOC */
    {{UINT32_C(0x00000000),UINT32_C(0x00000220),UINT32_C(0x00000000),UINT32_C(0x00000400)}}, /* 272 : LONG,UNDOC,X86_64 */
};
