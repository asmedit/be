...
const char * const warning_name[34] = {
	NULL,
	"bnd",
	"environment",
	"float-denorm",
...
const struct warning_alias warning_alias[37] = {
	{ "all",                      WARN_IDX_ALL },
...
const char * const warning_help[34] = {
	NULL,
...
const uint8_t warning_default[33] = {
	WARN_INIT_ON,
	WARN_INIT_ON,
	WARN_INIT_ON,
	WARN_INIT_OFF,
...
uint8_t warning_state[33];	/* Current state */
