...
#define IF_NEVER             87 /* Instruction never implemented                                    */
#define IF_NOP               88 /* Instruction is always a (nonintentional) NOP                     */
#define IF_VEX               89 /* VEX or XOP encoded instruction                                   */
#define IF_EVEX              90 /* EVEX encoded instruction                                         */
                                /* 90...95 reserved                                                 */
...
#define IFM_OBSOLETE        UINT32_C(0x00400000)     /*  86 */
#define IFM_NEVER           UINT32_C(0x00800000)     /*  87 */
#define IFM_NOP             UINT32_C(0x01000000)     /*  88 */
#define IFM_VEX             UINT32_C(0x02000000)     /*  89 */
#define IFM_EVEX            UINT32_C(0x04000000)     /*  90 */
...
#define IF_FEATURE_FIELD      1 /* IF_PRIV (32) ... IF_EVEX (90)                                    */
...
extern const iflag_t insns_flags[273];
