...
so maybe I should finish <a href="https://tonpa.guru/stream/2019/2019-06-09%20A64%20Assembler.htm">one of my own</a>. Furtunately MIPS and PowerPC disassemblers are easy to implement. There could also `be` 8-bit pivot for 8080/8085/Z80, 6502, HC08, F8 or for bytecode of virtual machines: JVM, CLR, BEAM, EBC (EFI Byte Code), which are also easy to implement.
